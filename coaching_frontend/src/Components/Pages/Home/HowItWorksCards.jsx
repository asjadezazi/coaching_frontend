...
import pinkBg from '../../../components/SvgIcons/pinkbg.svg'
import purplebg from '../../../components/SvgIcons/purplebg.svg'
...
// import data from '../../../data/howItWorksCard'
        ...
        return (
          <div className={`lg:py-5 lg:flex ${isReverseLayout ? 'lg:flex-row-reverse' : ''} justify-center items-center cursor-pointer`} key={index} onClick={()=> navigate('/contact')}>
            ...
            <div className=" py-40 lg:py-10 px-10">
              <div data-aos="zoom-in" className={`flex lg:relative top-10`}>
                <div
