...
const MernCourseHeading = () => {
  return (
    <div  data-aos="slide-right" className='mt-28 p-7  '>

            {/* heading */}
            <h1 className='text-8xl lg:text-5xl font-bold'>Full Stack Development:<span className='text-[#4e3dff]'> With <br /> Mern</span> </h1>
...
export default MernCourseHeading