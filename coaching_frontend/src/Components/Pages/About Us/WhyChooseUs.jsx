    ...
    return (
        <div className='flex flex-col-reverse lg:flex-row-reverse lg:px-20 bg-white'>
            <div className='lg:w-2/4 mt-20 flex lg:flex-col justify-center items-center'>
                <img
                    //  data-aos="zoom-in"
                    src={lady} alt="" className='lg:size-96' />
                <img
                    //  data-aos="zoom-in" 
                    src={boy} alt="" className='lg:size-96 hidden lg:inline' />
            </div>
            <div className='p-10 my-10 lg:w-2/4 lg:h-3/4 flex flex-col gap-10 lg:gap-5'>
                <h1
                    // data-aos="slide-right"
                    className='text-8xl px-3 text-[#4e3dff] font-bold lg:text-5xl'>Why Choose Us ?</h1>
                <p
                    //  data-aos="zoom-in"
                    className='bg-indigo-50 rounded-xl text-5xl lg:text-xl text-[#67687A] leading-snug p-5'>
